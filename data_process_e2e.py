...
if __name__ == '__main__':
	...
	train_file_path_list_pred = [os.path.join(pred_traj_root, '{:04d}.txt'.format(seq)) for seq in train_sequences]
	train_file_path_list_gt = [os.path.join(gt_traj_root, '{:04d}.txt'.format(seq)) for seq in train_sequences]
	train_file_path_list = (train_file_path_list_pred, train_file_path_list_gt)
	val_file_path_list_pred = [os.path.join(pred_traj_root, '{:04d}.txt'.format(seq)) for seq in val_sequences]
	val_file_path_list_gt = [os.path.join(gt_traj_root, '{:04d}.txt'.format(seq)) for seq in val_sequences]
