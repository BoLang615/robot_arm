...
data_root = '/data/kitti/mots/training/trajectory'
...
if __name__ == '__main__':
	...
	train_file_path_list = [os.path.join(data_root, '{:04d}.txt'.format(seq)) for seq in train_sequences]
	val_file_path_list = [os.path.join(data_root, '{:04d}.txt'.format(seq)) for seq in val_sequences]
